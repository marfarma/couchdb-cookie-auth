...
(function () {
    ...
    // get value of setting _config/couch_httpd_auth/authentication_db and cache result
    // for future use
    var getAuthDb = Promise.method(function () {
        ...
        return getConfig("couch_httpd_auth", "authentication_db", undefined)
            ...
            if (result === undefined) {
                throw new Error('_config/couch_httpd_auth/authentication_db required');
            }
            authDb = result;
            return result;
        });
